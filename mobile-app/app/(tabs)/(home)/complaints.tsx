...
import { View, Text, TouchableOpacity, TextInput, ScrollView, Image, Pressable, Alert } from "react-native";
...
export default function ComplaintScreen() {
  ...
  const handleSubmitComplaint = async() => {
    try{
      setLoading(true);
      const response = await uploadComplaintImage(image, location, description);
      ...
      setLoading(false);
      Alert.alert("Error", "Failed to submit complaint. Please try again.");r
    }
  }
